        ...
        <div className={styles.bottomSection}>
          <div className={styles.socialArea}>
            ...
            <div className={styles.socialIcons}>
              <a href="#" className={`${styles.socialIcon} ${styles.facebook}`} aria-label="Facebook"><Facebook size={16} /></a>
              <a href="#" className={`${styles.socialIcon} ${styles.instagram}`} aria-label="Instagram"><Instagram size={16} /></a>
